...
import { Form, Input, Button, Card, Typography, message, Spin, Row, Col, Upload } from "antd";
...
const AdminProfile = () => {
    ...
    const handleUpdateProfile = async (values) => {
        ...
        try {
            ...
            const response = await api.put(`/users/update-user-by-id/${user._id}`, formData, {
                headers: {
    ...
    return (
        <div className="p-6 max-w-5xl mx-auto">
            <div className="mb-6">
                ...
                <Text type="secondary">Manage your profile details and security settings</Text>
            </div>
                ...
                <Col xs={24} lg={14}>
                    <Card title="Profile Information" className="shadow-sm h-full">
                        ...
                        >
                            ...
                            >
                                <Input prefix={<User size={18} className="text-gray-400" />} placeholder="Your Name" size="large" />
                            </Form.Item>
                            ...
                            <Form.Item
                                ...
                                label="Email Address"
                            >
                                <Input prefix={<Mail size={18} className="text-gray-400" />} disabled className="bg-gray-50 text-gray-500" size="large" />
                            </Form.Item>
                ...
                <Col xs={24} lg={10}>
                    <Card title="Security" className="shadow-sm h-full">
                        ...
                        >
                            ...
                            >
                                <Input.Password prefix={<Lock size={18} className="text-gray-400" />} placeholder="New Password" size="large" />
                            </Form.Item>
                            ...
                            >
                                <Input.Password prefix={<Lock size={18} className="text-gray-400" />} placeholder="Confirm Password" size="large" />
                            </Form.Item>
