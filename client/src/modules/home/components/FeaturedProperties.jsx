...
const FeaturedProperties = () => {
    ...
    useEffect(() => {
        const fetchProperties = async () => {
            try {
                ...
                const res = await axios.get(`${import.meta.env.VITE_API_URL}/properties/fetch-all-property?is_verified=true&limit=6`);
    ...
    if (loading) return <div className="text-center py-20 text-gray-500">Loading Properties...</div>;
        ...
        <section className="py-16 bg-gray-50">
            <div className="container mx-auto px-4">
                <div className="flex justify-between items-end mb-8">
                    ...
                    <Link to="/properties" className="hidden md:flex items-center text-gray-900 font-semibold hover:text-blue-600 transition">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {properties.map((property) => (
                        ...
                        >
                            ...
                            {/* Background Image */}
                            <img
                                src={property.images?.[0]?.image_url ? `${import.meta.env.VITE_API_URL.replace('/api', '')}${property.images[0].image_url}` : 'https://placehold.co/600x800?text=No+Image'}
                                alt={property.title}
                            ...
                            <div className="absolute bottom-0 left-0 w-full p-5 text-white z-10">
                                ...
                                {/* Title & Location */}
                                <h3 className="text-xl font-bold mb-1 leading-tight">{property.title}</h3>
                                ...
                                >
                                    {/* WhatsApp SVG Icon */}
                                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5 text-indigo-900">
                ...
                <div className="mt-8 text-center md:hidden">
                    <Link to="/properties" className="inline-flex items-center text-gray-900 font-semibold hover:text-blue-600">
                        View All Properties <ArrowRight className="w-5 h-5 ml-1" />
                    </Link>
                </div>
            </div>
