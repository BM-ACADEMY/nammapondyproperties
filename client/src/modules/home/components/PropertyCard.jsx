            ...
            <div className="absolute bottom-0 left-0 w-full p-6 text-white z-10 flex flex-col justify-end h-full pointer-events-none">
                <div className="mt-auto pointer-events-auto">
                    ...
                    <button
                        ...
                        className={`w-full bg-white hover:bg-[#e7e5f4] text-gray-900 font-bold py-2.5 rounded-xl flex items-center justify-center gap-2.5 transition-all shadow-lg active:scale-[0.98] opacity-90 group-hover:opacity-100 duration-300 ${onWhatsAppClick ? "cursor-pointer pointer-events-auto" : "pointer-events-none"}`}
                    >
                        {/* WhatsApp SVG Icon */}
                        <svg
                            viewBox="0 0 24 24"
