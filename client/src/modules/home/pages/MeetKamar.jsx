...
const MeetKamar = () => {
    return (
        <section className="bg-white py-12 px-4 sm:px-6 lg:px-8 mt-8">
            ...
            >
                {/* Background Layer */}
                <div className="absolute inset-0 rounded-[2rem] bg-[#fdfbf7] shadow-sm border border-white/40 overflow-hidden z-0 transition-transform duration-300 group-hover:scale-[1.01]"></div>
