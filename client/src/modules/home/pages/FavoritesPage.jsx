    ...
    useEffect(() => {
        if (user && user.wishlist) {
            ...
            setFavorites(prevFavorites => prevFavorites.filter(fav =>
                user.wishlist.some(w => (typeof w === 'string' ? w : w._id) === fav._id)
            ));
        } else if (user) {
            fetchFavorites();
        }
    ...
    if (!user) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center px-4">
                ...
                <p className="text-gray-500 mb-6">You need to be logged in to view your favorite properties.</p>
            ...
            <div className="container mx-auto px-4">
                ...
                {favorites.length > 0 ? (
                    ...
                    <div className="flex flex-col items-center justify-center min-h-[50vh] text-center">
                        ...
                        <p className="text-gray-500 mb-6">Start exploring properties and save them here!</p>
                        <Link to="/properties" className="bg-blue-600 text-white px-6 py-2 rounded-full hover:bg-blue-700 transition">
                            Browse Properties
                        </Link>
                    </div>
                )}
