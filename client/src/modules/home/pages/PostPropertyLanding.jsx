...
const PostPropertyLanding = () => {
    ...
    return (
        <div className="min-h-screen bg-[#f1f7ff] pt-12 pb-20 px-4">
            ...
            <div className="mt-20 border-t border-gray-200 pt-8 text-center text-xs text-[#999999]">
                © 2026 NammaPondy Properties. All Rights Reserved.
            </div>
        </div>
    );
};
