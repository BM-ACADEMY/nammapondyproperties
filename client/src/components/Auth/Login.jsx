    ...
    <div className="flex items-center justify-center min-h-[calc(100vh-80px)] bg-gray-50 p-4">
      <div className="bg-white text-gray-500 w-full max-w-sm mx-4 md:p-8 p-6 text-left text-sm rounded-2xl shadow-[0px_0px_20px_0px_rgba(0,0,0,0.08)]">
        ...
        <div className="flex bg-gray-100 rounded-full p-1 mb-6">
          <button
            type="button"
            onClick={() => { setActiveTab("email"); setIdentifier(""); }}
            className={`flex-1 py-1.5 text-xs font-medium rounded-full transition-all duration-200 ${activeTab === "email"
          ...
          <button
            type="button"
            onClick={() => { setActiveTab("phone"); setIdentifier(""); }}
            className={`flex-1 py-1.5 text-xs font-medium rounded-full transition-all duration-200 ${activeTab === "phone"
                ? "bg-white text-gray-800 shadow-sm"
                : "text-gray-500"
              }`}
          >
        ...
        <p className="text-center text-xs mt-2 mb-5">
          ...
          <Link to="/signup" className="text-indigo-500 hover:text-indigo-700 font-medium">
            Sign up
          </Link>
        </p>
