/**
 * Generates an HTML email template for contact messages (Admin Notification)
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        .message-box { background: #f9f9f9; padding: 15px; border-radius: 8px; margin-top: 20px; border: 1px solid #eee; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          ...
          <div class="info-item">
            <span class="label">Interested in Selling?</span>
            <span class="value">${contact.sellProperty ? "Yes" : "No"}</span>
          </div>
          ...
          <div style="text-align: center;">
            <a href="${process.env.CLIENT_URL}/admin/forms/contact-messages" class="btn">View in Admin Panel</a>
          </div>
        </div>
        <div class="footer">
